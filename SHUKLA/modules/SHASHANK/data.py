...
GRP = "@II_4ST_READY_FOR_FUCKING_II|@I_M_FIGHTER"

GROUP = [-1001948563227, -1002067383891]

VERIFIED_USERS = [5655278269, 5491939151]

Owners = "@ll_4st_MIND_GAMER_II"
...
OneWord = ["HAHA", "AAJA", "TERI", "MA", "KI", "CHUT", "ME", "LAND", "MARU", "#_4ST", "KA", "TERI", "MAA", "KI", "CHADTI", "JAVANI", "PE", "#_4ST", "KA", "LAND", "GHUSA", "DU", "BOL", "#_4ST", "PAPA", "OP", "𝙊𝙔𝙀", "𝙈𝘼𝘼", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙈𝘼𝙍", "𝙂𝘼𝙔𝙄", "𝙆𝙔𝘼", "𝙈𝘼𝘼", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙆𝘼𝙃𝘼", "𝙂𝘼𝙔𝙄", "𝙏𝙀𝙍𝙄", "𝙎𝙋𝙀𝙀𝘿", "𝘼𝘼𝙋𝙉𝙄", "𝙈𝘼𝘼", "𝘾𝙃𝙐𝘿𝘼𝙉𝙀", "𝙆𝙀𝙇𝙄𝙔𝙀", "𝙆𝙔𝘼", "ᴏʏᴇ", "ʙᴏᴛ", "ᴋᴇ", "ᴄʜᴏᴅᴇ", "#_4sᴛ_ᴘᴀᴘᴀ_ᴋɪ", "sᴘᴇᴇᴅ", "ɴʜɪ", "ᴘᴋᴅ", "sᴋᴛᴀ", "ᴋʏᴀ", "🅣🅔🅡🅐", "🅑🅐🅐🅟", "🅣🅨🅟🅘🅝🅖", "🅚🅡🅚🅔", "🅣🅔🅡🅘", "🅜🅐🅐", "🅓🅘", "🇧‌‌🇦‌‌🇦‌‌🇵‌", ‌"🇸‌‌🇪‌", ‌"🇸‌‌‌🇵‌‌🇪‌‌🇪‌‌🇩‌", ‌"🇲‌‌🇦‌‌🇹‌‌🇨‌‌🇭‌", ‌"🇰‌‌🇦‌‌🇷‌‌🇪‌‌🇬‌‌🇦‌", ‌"🇹‌‌🇪‌‌🇷‌‌🇮‌", ‌"🇲‌‌🇦‌‌🇦‌", ‌"🇲‌‌🇦‌‌🇷‌", ‌"🇯‌‌🇦‌‌🇾‌‌🇪‌", ‌"🇦‌‌🇦‌‌🇯‌", ‌"🇦‌‌🇬‌‌🇷‌", ‌‌"🇲‌‌🇪‌‌🇷‌‌🇪‌", ‌‌"🇸‌‌🇪‌", ‌"🇧‌‌🇦‌‌🇨‌‌🇭‌", ‌"🇰‌‌🇪‌", ‌"🇧‌‌🇭‌‌🇦‌‌🇬‌‌🇦‌", "🇹‌‌🇴‌",  "𝐓𝐄𝐑𝐈", "𝐌𝐀𝐘𝐘𝐀", "𝐊𝐎", "𝐀𝐀𝐉", ",𝐌𝐄𝐑𝐄", "#_4𝐒𝐓 𝐊𝐄 𝐋𝐀𝐍𝐃 𝐒𝐄", "𝐍𝐀𝐆𝐍𝐀", "𝐊𝐑", "𝐊𝐄", "𝐂𝐇𝐎𝐃", "𝐃𝐔", "AJA", "TERI", "MAA", "KI", "CHUT", "FAAD", "DUNGA", "HIJDE", "TERA", "BAAP", "HU", "KIDXX", "SPEED", "PAKAD", "BHEN KE LAUDE", "AA BETA", "AAGYA", "TERI", "MAA ", "CHODNE", "AB", "TERI ", "MAA", "CHUDEGI", "KUTTE", "KI", "TARAH", "BETA", "TERI", "MAA", "KE", "BHOSDE", "ME", "JBL", "KE", "SPEAKER", "DAAL", "KAR", "BASS", "BOOSTED", "SONG", "SUNUNGA", "PURI", "RAAT", "LAGATAR", "TERI", "MAA", "KE", "SATH", "SEX", "KARUNGA🔥", "TERI", "MAA", "KE", "BOOBS", "DABAUNGA","XXX","TERI","MAA","KAA","CHUT","MARU","RANDI","KEE","PILEE","TERI","MAA","KAA","BHOSDAA","MARU","SUAR","KEE","CHODE","TERI","MAAA","KEEE","NUDES","BECHUNGA","RANDI","KEE","PILLE","TERI","MAAA","CHODU","SUAR","KEEE","PILEE","TERIII","MAAA","DAILYY","CHUDTTI","HAII","MADHARCHOD","AUKAT","BANAA","LODE","TERAA","BAAP","HUU","TERI","GFF","KAA","BHOSDAA","MARUU","MADHARCHOD","TERI ","NANAI","KAA","CHUTT","MARU","TERII","BEHEN","KAAA","BHOSDAA","MARU","RANDII","KEEE","CHODE","TERI","DADI","KAAA","BOOR","GARAM","KARR","TERE","PUREE","KHANDAN","KOOO","CHODUNGAA","BAAP","SEE","BAKCHODI","KAREGAA","SUARR","KEEE","PILLEE","NAAK","MEEE","NETAA","BAAP","KOO","KABHII","NAAH","BOLNAA","BETAA","CHUSS","LEEE","MERAA","LODAA","JAISE","ALUU","KAAA","PAKODAA","TERI","MAAA","BEHEN","GFF","NANI","DIIN","RAAT","SOTEE","JAGTEE","PELTAA","HUUU","LODEE","CHAAR","CHAWNII","GHODEE","PEEE","TUMM","MEREE","LODEE","PEE","TERI","MAA","KAAA","BOOBS","#FEEL_ME","𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝙆𝙊","𝘾𝙃𝙊𝘿𝙀𝙂𝘼"," #_4𝙨𝙩_𝙏𝙃𝙊𝙈𝘼𝙎","𝙏𝙀𝙍𝙄 𝘿𝙄𝘿𝙄","𝙆𝙀 𝘾𝙃𝙐𝙏 𝙈𝙀"," #_4𝙎𝙏_𝙆𝘼 𝙇𝘼𝙉𝘿","𝘿𝘼𝙇𝘿𝙐"," #_4𝙎𝙏_𝙈𝙄𝙉𝘿_𝙂𝘼𝙈𝙀𝙍_𝙊𝙋 ","𝙍𝘼𝙉𝘿𝙄","𝙆𝙀 𝘾𝙃𝙊𝘿𝙀","DABATA HU", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝘾𝙃𝙐𝙏", "𝙈𝘼𝘼", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝘽𝘼𝘼𝙋", "𝙎𝙀", "𝙎𝙋𝙀𝙀𝘿", "𝙈𝘼𝘼𝙏𝘾𝙃", "𝙆𝘼𝙍𝙀𝙂𝘼", "𝙇𝙊🅓𝙀", "𝘼𝙐𝙆𝙆𝘼𝙏", "𝘽𝘼𝙉𝘼", "𝙃𝘼𝙂", "𝘿𝙄𝙔𝘼𝙉𝘼", "𝙎𝙋𝙀𝙀𝘿", "𝙆𝙍", "𝙍𝘼𝙃𝘼", "𝙆𝘼𝙃𝘼", "𝙂𝘼𝙔𝙄", "𝙏𝙀𝙍𝙄", "𝙎𝙋𝙀𝙀𝘿", "𝙃𝙄𝙅𝘿𝙀", "𝘽𝙊𝙇", "#_4𝙎𝙏 𝙋𝘼𝙋𝘼 𝙊𝙋", "😘"]
