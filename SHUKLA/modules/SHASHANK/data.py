...
OneWord = [ "𝘼𝘼𝙅𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙊", "𝘼𝘼𝙅", "4𝙎𝙏", "𝙆𝙀", "𝙇𝘼𝙉𝘿", "𝙆𝘼", "𝙕𝙃𝘼𝙏𝙆𝘼", "AJA", "TERI", "MAA", "KI", "CHUT", "FAAD", "DUNGA", "HIJDE", "TERA", "BAAP", "HU", "KIDXX", "SPEED", "PAKAD", "KYA", "BE", "HAG", "DIYA", "SPEED", "KE", "NAAM", "PE", "4𝙎𝙏", "𝙋𝘼𝙋𝘼", "𝙆𝙀", "𝙎𝘼𝙈𝙉𝙀", "𝙎𝙋𝙀𝙀𝘿", "𝙉𝙃𝙄", "𝙋𝙆𝘿" "𝙋𝘼𝙍𝘼", "𝙆𝙔𝘼", "BHEN KE LAUDE", "AA BETA", "AAGYA", "TERI", "MAA ", "CHODNE", "AB", "TERI ", "MAA", "CHUDEGI", "KUTTE", "KI", "TARAH", "BETA", "TERI", "MAA", "KE", "BHOSDE", "ME", "JBL", "KE", "SPEAKER", "DAAL", "KAR", "BASS", "BOOSTED", "SONG", "SUNUNGA", "PURI", "RAAT", "LAGATAR", "TERI", "MAA", "KE", "SATH", "SEX", "KARUNGA🔥", "TERI", "MAA", "KE", "BOOBS", "DABAUNGA","XXX","TERI","MAA","KAA","CHUT","MARU","RANDI","KEE","PILEE","TERI","MAA","KAA","BHOSDAA","MARU","SUAR","KEE","CHODE","TERI","MAAA","KEEE","NUDES","BECHUNGA","RANDI","KEE","PILLE","TERI","MAAA","CHODU","SUAR","KEEE","PILEE","TERIII","MAAA","DAILYY","CHUDTTI","HAII","MADHARCHOD","AUKAT","BANAA","LODE","TERAA","BAAP","HUU","TERI","GFF","KAA","BHOSDAA","MARUU","MADHARCHOD","TERI ","NANAI","KAA","CHUTT","MARU","TERII","BEHEN","KAAA","BHOSDAA","MARU","RANDII","KEEE","CHODE","TERI","DADI","KAAA","BOOR","GARAM","KARR","TERE","PUREE","KHANDAN","KOOO","CHODUNGAA","BAAP","SEE","BAKCHODI","KAREGAA","SUARR","KEEE","PILLEE","NAAK","MEEE","NETAA","BAAP","KOO","KABHII","NAAH","BOLNAA","BETAA","CHUSS","LEEE","MERAA","LODAA","JAISE","ALUU","KAAA","PAKODAA","TERI","MAAA","BEHEN","GFF","NANI","DIIN","RAAT","SOTEE","JAGTEE","PELTAA","HUUU","LODEE","CHAAR","CHAWNII","GHODEE","PEEE","TUMM","MEREE","LODEE","PEE","TERI","MAA","KAAA","BOOBS","DABATA HU", "𝙆𝙔𝘼", "𝘽𝙀𝙏𝘼", "𝘾𝙃𝙐𝘿", "𝙂𝘼𝙔𝘼", "4𝙎𝙏 𝙋𝘼𝙋𝘼", "𝙆𝙀", "𝙎𝘼𝙈𝙉𝙀", " #𝙍𝘼𝙉𝘿𝙄_𝘿𝙁𝙉", " #𝙁𝙀𝙀𝙇_𝙐𝙍_𝘿𝘼𝘿𝘿𝙔_4𝙎𝙏 ", " #𝙎𝙋𝙀𝙀𝘿_𝙆𝘼𝙃𝘼_𝙂𝘼𝙔𝙄_𝙏𝙀𝙍𝙄_𝙃𝙄𝙅𝘿𝙀"]
